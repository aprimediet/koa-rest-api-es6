 ...
 * curl -X POST -H "Content-Type: application/x-www-form-urlencoded" -d 'username=azagthoth@gmail.com&password=secret&grant_type=password&client_id=koa-rest-api&client_secret=secret' "https://ion-conf-api.damiendev.com/api/auth/token"
 *
